...
export const BRV_PROMOS_DATA: Record<string, { name: string; comboData: string; price: number; list: { n: string; q: number }[] }> = {
  ...
  "50mil_seguidores": { name: "Promo 50Mil Seguidores", comboData: "PROMO 50MIL SEGUIDORES — CONJUNTO NERU (POLERA NERU + PANTALON BRATZ) + CONJUNTO BOXY (POLERA BOXYFIT + PANTALON BRATZ)", price: 99, list: [{ n: "POLERA NERU", q: 1 }, { n: "PANTALON BRATZ", q: 1 }, { n: "POLERA BOXYFIT", q: 1 }, { n: "PANTALON BRATZ", q: 1 }] },
  // ── Promo Boxyfit ────────────────────────────────────────────────────────
