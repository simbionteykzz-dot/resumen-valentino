...
export const BRV_PROMOS_DATA: Record<string, { name: string; comboData: string; price: number; list: { n: string; q: number }[] }> = {
  ...
  "50mil_neru":   { name: "50Mil — Conjunto Neru",  comboData: "PROMO 50MIL SEGUIDORES — CONJUNTO NERU (POLERA NERU + PANTALON BRATZ)",   price: 99, list: [{ n: "POLERA NERU", q: 1 }, { n: "PANTALON BRATZ", q: 1 }] },
  "50mil_boxy":   { name: "50Mil — Conjunto Boxy",  comboData: "PROMO 50MIL SEGUIDORES — CONJUNTO BOXY (POLERA BOXYFIT + PANTALON BRATZ)", price: 99, list: [{ n: "POLERA BOXYFIT", q: 1 }, { n: "PANTALON BRATZ", q: 1 }] },
  // ── Promo Boxyfit ────────────────────────────────────────────────────────
